  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      ...
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40"> 
        ...
        <Title heading='Transform Images Into Creative Content' description="Upload your product and model images to instantly create unique social media visuals, short-form videos, and marketing content."/>
        ...
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              <label htmlFor="name" className="block text-sm mb-4">Campaign Name</label>
              <input type="text" id="name" value={name} onChange={(e)=>setName(e.target.value)} placeholder="Campaign Name" required className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"/>
            </div>
            <div className="mb-4 text-gray-300">
              <label htmlFor="productName" className="block text-sm mb-4">Product Name</label>
              <input type="text" id="productName" value={productName} onChange={(e)=>setProductName(e.target.value)} placeholder="Product Name" required className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"/>
            </div>
            <div className="mb-4 text-gray-300">
              <label htmlFor="productDescription" className="block text-sm mb-4">Product Details <span className="text-xs text-violet-400">(Optional)</span></label>

              <textarea id="productDescription" rows={4} value={productDescription} onChange={(e)=>setProductDescription(e.target.value)} placeholder="Product Details"
            ...
            <div className="mb-4 text-gray-300">
              <label htmlFor="userPrompt" className="block text-sm mb-4">Creative Prompt <span className="text-xs text-violet-400">(Optional)</span></label>
